...
//        testUpdateProduct();
        //testDeleteProduct();
        testGetProductQuantityInInventory();
    }
...
//    }
    ...
    private static void testGetProductQuantityInInventory() {
        ProductDAO productDAO = new ProductDAO();
        int productId = 1; // Replace with a valid product ID

        int quantity = productDAO.getProductQuantityInInventory(productId);

        System.out.println("Product Quantity in Inventory:");
